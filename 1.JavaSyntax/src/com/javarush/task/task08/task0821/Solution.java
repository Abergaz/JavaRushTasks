...
public class Solution {
    ...
    public static Map<String, String> createPeopleList() {
        ...
        hashMap.put("Загреба"," Сергей");
        hashMap.put("Загреба1","Ксения");
        hashMap.put("Образцова","Юлия");
        hashMap.put("Загреба2","Александр");
        hashMap.put("Загреба3","Марина");
        hashMap.put("Загреба4","Роман");
        hashMap.put("Новикова","Александра");
        hashMap.put("Новиков","Александр");
        hashMap.put("Загреба5","Даниил");
        hashMap.put("Загреба","Петр");
        return hashMap;
    }
