...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        test(solution.getProxy(Item.class, Small.class.getInterfaces()));           //true false true
    ...
    public <T extends Item> T getProxy(Class<T> clazz, Class<?>... classes){
        ...
        T item = (T) Proxy.newProxyInstance(clazz.getClassLoader(),interfaces ,new ItemInvocationHandler());
        return item;
    }
