...
public class Solution {
    ...
    public static SomeInterfaceWithMethods getProxy() {
        ...
        SomeInterfaceWithMethods someInterfaceWithMethods = (SomeInterfaceWithMethods) Proxy.newProxyInstance(original.getClass().getClassLoader(),original.getClass().getInterfaces(),customInvocationHandler);
