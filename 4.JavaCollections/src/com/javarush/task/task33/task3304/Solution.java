...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        o.writeValue(stringWriter,one);
        String s = stringWriter.toString();
        return o.readValue(s.replaceFirst(one.getClass().getSimpleName().toLowerCase(),resultClassObject.getSimpleName().toLowerCase()), resultClassObject);
    }
